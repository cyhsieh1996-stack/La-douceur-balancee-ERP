...
class InboundPage(ctk.CTkFrame):
    ...
    def __init__(self, master):
        ...
        ctk.CTkLabel(title_box, text="進貨與入庫", font=Font.TITLE, text_color=Color.TEXT_DARK).pack(anchor="w")
        ctk.CTkLabel(title_box, text="登錄原料進貨、批號與效期，系統會同步更新原料庫存與參考單價。", font=Font.BODY, text_color=Color.TEXT_LIGHT).pack(anchor="w", pady=(4, 0))
