...
class DashboardPage(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.stats_frame.pack(fill="x", pady=(20, 20)) # 上方留一點邊距即可
    ...
    def create_left_panel(self, parent):
        ...
        self.create_table_section(frame, "🚨 原料缺貨警報", ["名稱", "目前", "安全", "單位"], [90, 50, 50, 40], "tree_low_stock")
        self.create_table_section(frame, "⚠️ 原料即將過期", ["效期", "名稱", "批號"], [80, 90, 70], "tree_exp_mat")

    def create_center_panel(self, parent):
        frame = ctk.CTkFrame(parent, fg_color="transparent")
        frame.grid(row=0, column=1, padx=5, sticky="nsew")
        self.create_table_section(frame, "🏆 本週熱銷 Top 3", ["排名", "產品名稱", "銷量"], [40, 140, 60], "tree_top3")

    def create_right_panel(self, parent):
        frame = ctk.CTkFrame(parent, fg_color="transparent")
        frame.grid(row=0, column=2, padx=5, sticky="nsew")
        self.create_table_section(frame, "⏳ 成品即將過期", ["效期", "產品", "批號"], [80, 100, 80], "tree_exp_prod")
